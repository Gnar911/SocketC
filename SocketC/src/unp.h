...
#include	"include/config.h"	/* configuration options for current OS */
...
// Abstract out some of the difference between
...
//            const struct timespec *, const _sigset_t *);
#endif
...
ssize_t	 Read(int, void *, size_t);
  #if defined(_WIN32)
void	 Sigaddset(_sigset_t *, int);
void	 Sigdelset(_sigset_t *, int);
void	 Sigemptyset(_sigset_t *);
void	 Sigfillset(_sigset_t *);
int		 Sigismember(const _sigset_t *, int);
void	 Sigpending(_sigset_t *);
void	 Sigprocmask(int, const _sigset_t *, _sigset_t *);
#endif
